...
import { Play, Edit2, Share2, Calendar, RefreshCw, BarChart3, Layers, TrendingUp, Activity, Cpu, GitFork, FileText, Zap, Copy } from "lucide-react";
...
export default function WorkflowCardComponent({ workflow }: { workflow: WorkflowCardType }) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <button
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors hover:bg-black/7 ml-auto"
          style={{ color: "var(--text-muted)" }}
        >
          <Share2 size={11} />
          Share
