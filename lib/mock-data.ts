...
export const semanticTables: SemanticTable[] = [
  {
    ...
    relations: [],
    columns: [
      { name: "claim_id", type: "TEXT", description: "Unique claim identifier (PK)", samples: "—" },
      { name: "patient_gid", type: "TEXT", description: "Patient global ID (FK → PATIENT)", samples: "—" },
      { name: "drug_id", type: "TEXT", description: "Drug identifier (FK → DRUG_TABLE)", samples: "—" },
      { name: "physician_key", type: "TEXT", description: "Prescriber key (FK → PHYS_REF)", samples: "—" },
      { name: "primary_plan_id", type: "TEXT", description: "Primary payer plan (FK → PLAN)", samples: "—" },
      { name: "claim_status_code", type: "TEXT", description: "1=Dispensed, 2=Reversed", samples: "1, 2" },
      { name: "date_rx_filled", type: "TEXT", description: "Prescription fill date", samples: "2025-01-07" },
      { name: "ptd_final_claim", type: "NUMBER", description: "Final claim flag", samples: "1, null" },
      { name: "primary_patient_pay", type: "NUMBER", description: "Patient out-of-pocket cost", samples: "0, 12.50" },
      { name: "primary_plan_pay", type: "NUMBER", description: "Plan payment amount", samples: "120.00, 0" },
      { name: "product_ndc_code", type: "TEXT", description: "National Drug Code", samples: "—" },
      { name: "market_code", type: "TEXT", description: "Market segment code", samples: "—" },
    ],
  },
  {
    id: "drug-table",
    ...
    columns: [
      { name: "drug_id", type: "TEXT", description: "Drug identifier (PK)", samples: "—" },
  ...
  },
  {
    ...
    columns: [
      { name: "physician_key", type: "TEXT", description: "Physician surrogate key (PK)", samples: "—" },
  ...
  },
  {
    ...
    columns: [
      { name: "primary_plan_id", type: "TEXT", description: "Plan identifier (PK)", samples: "—" },
  ...
  },
  {
    ...
    relations: [{ targetTable: "rx-table", joinKey: "patient_gid", label: "patient_gid" }],
    columns: [
      { name: "patient_gid", type: "TEXT", description: "Patient global identifier (PK)", samples: "—" },
      { name: "market_code", type: "TEXT", description: "Market segment code", samples: "—" },
      { name: "patient_hipaa_birth_year", type: "TEXT", description: "HIPAA-compliant birth year", samples: "1975, 1982" },
      { name: "patient_gender", type: "TEXT", description: "Patient gender", samples: "M, F" },
      { name: "hh_income_code", type: "TEXT", description: "Household income bracket code", samples: "A, B, C" },
      { name: "patient_ethinicity", type: "TEXT", description: "Patient ethnicity", samples: "—" },
    ],
  },
];
